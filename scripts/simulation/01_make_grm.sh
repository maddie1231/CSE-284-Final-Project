#Script to call GCTA to make genetic relationship matrix for 1000G EUR chromosomes needed for the traits we are studying. (Paths point to files on lab cluster, change to your path from downloaded 1000G data)
